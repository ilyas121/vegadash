    ...
    return (
        <div className="block">
            <div className="block-header overflow-hidden">
                <h2 className="block-title animated fadeInDown">Environment</h2>
            </div>
            <div className="block-content">
                <div className="row items-push overflow-hidden">
                    <div className="col-xs-4 text-center animated fadeInLeft">
                    ...
                    <div className="col-xs-8 animated fadeInRight">
